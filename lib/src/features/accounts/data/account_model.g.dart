...
const AccountSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'creditCardDetails': PropertySchema(
      id: 1,
      name: r'creditCardDetails',
      type: IsarType.object,
      target: r'CreditCardDetails',
    ),
    ...
    r'loanDetails': PropertySchema(
      id: 3,
      name: r'loanDetails',
      type: IsarType.object,
      target: r'LoanDetails',
    ),
    ...
    r'timeDepositDetails': PropertySchema(
      id: 5,
      name: r'timeDepositDetails',
      type: IsarType.object,
      target: r'TimeDepositDetails',
    ),
  ...
  links: {},
  embeddedSchemas: {
    r'CreditCardDetails': CreditCardDetailsSchema,
    r'LoanDetails': LoanDetailsSchema,
    r'TimeDepositDetails': TimeDepositDetailsSchema
  },
  getId: _accountGetId,
...
int _accountEstimateSize(
  ...
  {
    final value = object.creditCardDetails;
    if (value != null) {
      bytesCount += 3 +
          CreditCardDetailsSchema.estimateSize(
              value, allOffsets[CreditCardDetails]!, allOffsets);
    }
  }
  {
    final value = object.loanDetails;
    if (value != null) {
      bytesCount += 3 +
          LoanDetailsSchema.estimateSize(
              value, allOffsets[LoanDetails]!, allOffsets);
    }
  }
  bytesCount += 3 + object.name.length * 3;
  {
    final value = object.timeDepositDetails;
    if (value != null) {
      bytesCount += 3 +
          TimeDepositDetailsSchema.estimateSize(
              value, allOffsets[TimeDepositDetails]!, allOffsets);
    }
  }
...
void _accountSerialize(
  ...
  writer.writeObject<CreditCardDetails>(
    offsets[1],
    allOffsets,
    CreditCardDetailsSchema.serialize,
    object.creditCardDetails,
  );
  writer.writeLong(offsets[2], object.hashCode);
  writer.writeObject<LoanDetails>(
    offsets[3],
    allOffsets,
    LoanDetailsSchema.serialize,
    object.loanDetails,
  );
  writer.writeString(offsets[4], object.name);
  writer.writeObject<TimeDepositDetails>(
    offsets[5],
    allOffsets,
    TimeDepositDetailsSchema.serialize,
    object.timeDepositDetails,
  );
...
Account _accountDeserialize(
  ...
  object.creditCardDetails = reader.readObjectOrNull<CreditCardDetails>(
    offsets[1],
    CreditCardDetailsSchema.deserialize,
    allOffsets,
  );
  object.id = id;
  object.loanDetails = reader.readObjectOrNull<LoanDetails>(
    offsets[3],
    LoanDetailsSchema.deserialize,
    allOffsets,
  );
  object.name = reader.readString(offsets[4]);
  object.timeDepositDetails = reader.readObjectOrNull<TimeDepositDetails>(
    offsets[5],
    TimeDepositDetailsSchema.deserialize,
    allOffsets,
  );
...
P _accountDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectOrNull<CreditCardDetails>(
        offset,
        CreditCardDetailsSchema.deserialize,
        allOffsets,
      )) as P;
    ...
    case 3:
      return (reader.readObjectOrNull<LoanDetails>(
        offset,
        LoanDetailsSchema.deserialize,
        allOffsets,
      )) as P;
    ...
    case 5:
      return (reader.readObjectOrNull<TimeDepositDetails>(
        offset,
        TimeDepositDetailsSchema.deserialize,
        allOffsets,
      )) as P;
...
const _AccounttypeValueEnumMap = {
  ...
  r'loan': AccountType.loan,
  r'timeDeposit': AccountType.timeDeposit,
};
...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition>
      creditCardDetailsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'creditCardDetails',
      ));
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition>
      creditCardDetailsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> loanDetailsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'loanDetails',
      ));
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition> loanDetailsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'loanDetails',
      ));
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition>
      timeDepositDetailsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'timeDepositDetails',
      ));
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition>
      timeDepositDetailsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'timeDepositDetails',
      ));
...
extension AccountQueryObject
    on QueryBuilder<Account, Account, QFilterCondition> {
  QueryBuilder<Account, Account, QAfterFilterCondition> creditCardDetails(
      FilterQuery<CreditCardDetails> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'creditCardDetails');
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition> loanDetails(
      FilterQuery<LoanDetails> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'loanDetails');
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition> timeDepositDetails(
      FilterQuery<TimeDepositDetails> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'timeDepositDetails');
    });
  }
}
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, CreditCardDetails?, QQueryOperations>
      creditCardDetailsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'creditCardDetails');
    });
  }
  ...
  QueryBuilder<Account, LoanDetails?, QQueryOperations> loanDetailsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'loanDetails');
    });
  }
  ...
  QueryBuilder<Account, TimeDepositDetails?, QQueryOperations>
      timeDepositDetailsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'timeDepositDetails');
    });
  }
