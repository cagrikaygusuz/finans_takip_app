...
const TransactionSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'sourceAccount': LinkSchema(
      id: 2618626579523294716,
      name: r'sourceAccount',
      target: r'Account',
      single: true,
    ),
...
Transaction _transactionDeserialize(
  ...
  object.id = id;
  object.type =
      _TransactiontypeValueEnumMap[reader.readStringOrNull(offsets[3])] ??
...
List<IsarLinkBase<dynamic>> _transactionGetLinks(Transaction object) {
  return [object.sourceAccount, object.destinationAccount, object.category];
}
...
void _transactionAttach(
  ...
  object.sourceAccount
      .attach(col, col.isar.collection<Account>(), r'sourceAccount', id);
...
extension TransactionQueryLinks
    on QueryBuilder<Transaction, Transaction, QFilterCondition> {
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition> sourceAccount(
      FilterQuery<Account> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'sourceAccount');
    });
  }
  ...
  QueryBuilder<Transaction, Transaction, QAfterFilterCondition>
      sourceAccountIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'sourceAccount', 0, true, 0, true);
    });
  }
